...
export function resolveTraitById(traits: Trait[], id: number | null): TraitWithDebug | null {
	if (id === null) return null;
	return (traits.find((t) => t[$internal]?.id === id) as TraitWithDebug | undefined) ?? null;
}
